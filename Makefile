...
UTFOLDER = ./Utility
CLFOLDER = ./Coloring
VOFOLDER = ./VtxOrdering
FSFOLDER = ./FullSyncOptimization
PERFOLDER = ./Permanance
LIBS     = -lm
...
TARGET_VO = driverForVertexOrdering
TARGET_MO = driverForOrderingWithMetis
TARGET_ND = driverForOrderingWithND
TARGET_PER = driverForGraphPermanence
TARGET_CPART = driverForGraphClusteringWithParitioning
...
#TARGET   = $(TARGET_4) $(TARGET_6) 
#TARGET   = $(TARGET_VO) $(TARGET_MO) $(TARGET_ND) $(TARGET_4) $(TARGET_7) $(TARGET_CPART)
#TARGET   = $(TARGET_PER) 
TARGET   = $(TARGET_CPART)
...
#IOBJECTS = loadBinary.o loadMetis.o loadMatrixMarket.o loadEdgeList.o 
...
VOFILES = $(wildcard $(VOFOLDER)/*.cpp)
VOOBJECTS = $(addprefix $(VOFOLDER)/,$(notdir $(VOFILES:.cpp=.o)))

PERFILES = $(wildcard $(PERFOLDER)/*.cpp)
PEROBJECTS = $(addprefix $(PERFOLDER)/,$(notdir $(PERFILES:.cpp=.o)))
...
$(TARGET_4): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_4).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_4) $(TARGET_4).o $(FSOBJECTS) $(IOOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(COOBJECTS) $(METIS_LIB)
...
$(TARGET_VO): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_VO).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_VO) $(TARGET_VO).o $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(LIBS)

$(TARGET_PER): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(PEROBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_PER).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_PER) $(TARGET_PER).o $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(LIBS)

$(TARGET_MO): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_MO).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_MO) $(TARGET_MO).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(METIS_LIB)

$(TARGET_ND): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_ND).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_ND) $(TARGET_ND).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(METIS_LIB)

$(TARGET_CPART): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_CPART).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_CPART) $(TARGET_CPART).o $(FSOBJECTS) $(IOOBJECTS) $(UTOBJECTS) $(CLOBJECTS) $(COOBJECTS) $(METIS_LIB)

$(TARGET_9): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_9).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_9) $(TARGET_9).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(CLOBJECTS) $(LIBS)

$(TARGET_10): $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(FSOBJECTS) $(CLOBJECTS) $(TARGET_10).o
	$(CPP) $(LDFLAGS) -o ./bin/$(TARGET_10) $(TARGET_10).o $(FSOBJECTS) $(IOOBJECTS) $(COOBJECTS) $(UTOBJECTS) $(VOOBJECTS) $(CLOBJECTS) $(LIBS)
...
$(VOFOLDER)/%.o: $(VOFOLDER)/%.cpp
	$(CPP) $(CPPFLAGS) -c $< -I$(INCLUDES) -o $@

$(PERFOLDER)/%.o: $(PERFOLDER)/%.cpp
	$(CPP) $(CPPFLAGS) -c $< -I$(INCLUDES) -o $@

clean:
	rm -f $(TARGET_1).o $(TARGET_2).o $(TARGET_3).o $(FSFOLDER)/*.o $(IOFOLDER)/*.o $(COFOLDER)/*.o $(UTFOLDER)/*.o $(VOFOLDER)/*.o $(PERFOLDER)/*.o $(CLFOLDER)/*.o blosc_filter/*.so

#wipe:
#	rm -f $(TARGET).o $(OBJECTS) $(TARGET) *~ *.bak

message:
	echo "\n Executables: "$(TARGET)" has/have been created \n"
